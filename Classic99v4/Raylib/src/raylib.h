...
// moved externally for compatibility
#include "raykeys.h"
...
RLAPI bool WindowShouldClose(void);                               // Check if application should close (RL_KEY_ESCAPE pressed or windows close icon clicked)
RLAPI void RequestClose(void);                                    // (mb) set the shouldClose flag
